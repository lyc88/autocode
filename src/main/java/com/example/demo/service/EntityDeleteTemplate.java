...
public class EntityDeleteTemplate implements CodeTemplate {
    ...
    public Template getTemplate() {
        try {
            return configuration.getTemplate("EntityDeleteReqVO.java.ftl");
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public void outFile() {
        try {
            ...
            FileUtils.write(new File(parentPath+packPathName+entityPath+table.getClassName()+"DeleteReqVO.java"),result,"utf-8");
        } catch (IOException e) {
            e.printStackTrace();
