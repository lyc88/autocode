...
public class ServiceTemplate implements CodeTemplate {
    ...
    public Template getTemplate() {
        try {
            return configuration.getTemplate("Service.java.ftl");
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public void outFile() {
        try {
            ...
            String servicePackage = (String) data.get("servicePackage");
            String module = servicePackage.replace(".", "/");
            ...
            String fileName = rootPath+parentPath +"/"+ module + "/" + table.getClassName() + "Service.java";
