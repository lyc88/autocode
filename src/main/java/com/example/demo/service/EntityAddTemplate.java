...
public class EntityAddTemplate implements CodeTemplate {
    ...
    public void outFile() {
        try {
            ...
            String entityAddPackage = (String) data.get("entityAddPackage");
            String module = entityAddPackage.replace(".", "/");
            ...
            String fileName = rootPath+parentPath +"/"+ module + "/" + table.getClassName() + "AddParam.java";
